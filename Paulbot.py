...
forbidden_keywords = ['Upload','Episode', 'series', 'share', 'post', 'link', 'movie', 'movies', 'season 2', 'season 3', 'Upload', 'Adulting','session', 'Lockdown', 'Download', 'save', 'gallery', 'phone', 'anyone' 'any', 'Any1', 'inbox', 'dm', 'facebook', 'tik tok', 'whatsapp', 'join', 'data', 'account', 'sellling', 'sell', 'buy', 'ha', 'channel', 'soon comes night', 'ink', 'of durban']
