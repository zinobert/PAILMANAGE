...
forbidden_keywords = ['Episode', 'series', 'share', 'post', 'link', 'movie', 'movies', 'season 2', 'season 3', 'Upload', 'Adulting','session', 'Lockdown', 'Download', 'save', 'gallery', 'phone', 'anyone' 'any']
